# Generated by Django 4.1.7 on 2023-06-24 00:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('Cashier', 'Cashier'), ('Booking Clerk', 'Booking Clerk'), ('Supervisor', 'Supervisor'), ('Release Clerk', 'Release Clerk')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='inmate_pictures/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jims_app.inmatefinancialaccount')),
                ('transaction_performed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='InmateInformationSheet',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_number', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='jims_app.inmatefinancialaccount')),
